      ...
      <div class="cfg-grid">
        ...
        <div class="cfg-field full"><label>ID de Plantilla Contrato</label>
          <input id="pr-doc-${i}" type="text" value="${esc_(p.plantillaContratoId||'')}"
                 placeholder="Id del Doc de Google (o pega la URL completa)" />
          <div class="cfg-hint">Documento de Google con los marcadores del contrato. Si lo dejas vacío se usa el que está configurado por defecto.</div>
        </div>
