...
async function abrirConfig_(){
  ...
  try{
    ...
    renderCfgGeneral_(); renderCfgProgramas_(); renderCfgPromos_(); renderCfgAgenda_(); renderCfgPlantillas_(); renderCfgListas_(); renderCfgAvanzado_();
...
function activarCfgTab_(name){
  ...
  ['general','programas','promos','agenda','plantillas','listas','avanzado'].forEach(p =>
