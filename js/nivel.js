...
function niveSetFiltro_(k, v) {
  ...
  if (k === 'estado') { NIVE.filtroEstado = v; NIVE.filtroNivel = '__ALL__'; NIVE.filtroInvitacion = '__ALL__'; }
  else if (k === 'nivel') { NIVE.filtroNivel = v; NIVE.filtroInvitacion = '__ALL__'; }
  else NIVE.filtroInvitacion = v;
}
...
function renderNiveCards_() {
  ...
  let list = niveBaseInvitacion_().slice().sort((a, b) => b.n - a.n);
