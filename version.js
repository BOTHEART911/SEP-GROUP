 ...
 * Oscar Polanía.
 * ------------------------------------------------------------
 * FASE 3 SEP · ENTREGA 3 (16/08) — dos ajustes de la vista Nivel de
 *   Inglés: la tarjeta muestra la EDAD junto a la fecha de nacimiento
 *   (misma cuenta de la vista Contador) y el emoji 🪪, que en Windows
 *   salía como un cuadro vacío, se cambió por 🆔 en Nivel de Inglés y
 *   en Contador.
 * ------------------------------------------------------------
 * FASE ANTERIOR: Fase 3 SEP · Entrega 2 (16/08) — botón PROCESOS en el
